...
class ApplicationModel {
  ...
  ApplicationModel copyWith({ApplicationStatus? status}) => ApplicationModel(
    id: id, missionId: missionId, nannyId: nannyId, nannyName: nannyName,
    nannyPhotoUrl: nannyPhotoUrl, nannyRating: nannyRating,
    nannyReviewCount: nannyReviewCount, hourlyRate: hourlyRate,
    experienceYears: experienceYears, skills: skills, message: message,
    appliedAt: appliedAt, status: status ?? this.status,
  );
}
...
final List<ApplicationModel> mockApplications = [
  ApplicationModel(
    id: 'a1', missionId: 'm1', nannyId: 'n1',
    nannyName: 'Ange Mba', nannyPhotoUrl: '',
    nannyRating: 4.8, nannyReviewCount: 23,
    hourlyRate: 2500, experienceYears: 3,
  ...
  ApplicationModel(
    id: 'a2', missionId: 'm1', nannyId: 'n2',
    nannyName: 'Marie-Claire Nzamba', nannyPhotoUrl: '',
    nannyRating: 4.5, nannyReviewCount: 11,
    hourlyRate: 2000, experienceYears: 2,
    skills: ['Cuisine', 'Dodo nourrissons', 'Activités créatives'],
    message: null,
    appliedAt: DateTime.now().subtract(const Duration(minutes: 15)),
  ),
  ApplicationModel(
    id: 'a3', missionId: 'm1', nannyId: 'n3',
    nannyName: 'Sylvie Obiang', nannyPhotoUrl: '',
    nannyRating: 4.9, nannyReviewCount: 47,
    hourlyRate: 3000, experienceYears: 6,
    skills: ['Premiers secours', 'Aide aux devoirs', 'Langues étrangères', 'Cuisine'],
