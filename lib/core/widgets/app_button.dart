...
class AppButton extends StatelessWidget {
  ...
  Widget _content() {
    if (isLoading) {
      return SizedBox(
        width: 22,
        height: 22,
        child: CircularProgressIndicator(color: _fgColor, strokeWidth: 2.5),
      );
    }
    return Row(
  ...
  Widget build(BuildContext context) {
    ...
    Widget btn = switch (type) {
      ...
      AppButtonType.danger => _gradientButton(disabled),
    ...
    return Opacity(
      ...
      child: SizedBox(
        ...
        child: ScaleTap(onTap: disabled ? null : onPressed, child: btn),
      ),
    );
  }
}
